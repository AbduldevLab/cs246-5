...
{ class Program
    {
        ...
        static void message()
        {
            ...
            Console.WriteLine("A: <A Shape> Add shape to canvas");
        ...
        public static bool MainMenu(Canvas canvas, Originator originator, Caretaker caretaker)
        {
            ...
            switch (Console.ReadKey().KeyChar)
            {
                ...
                case 'A':
                    ...
                    return true;
                case 'U':
                    undo(originator, caretaker, canvas);      //calling the undo method
                    DisplayCanvas1(canvas);                 //displaying result ater the undo as svg in the terminal
                    return true;
                case 'R':
                    redo(originator, caretaker, canvas);      //calling the redo method
                    DisplayCanvas1(canvas);                 //displaying result ater the redo as svg in the terminal
                    return true;
                case 'C':
        ...
        private static void CreateRandomCircle(Canvas canvas)
        {
            ...
            Circle c = (Circle)new CircleFactory("C" + rnd.Next(1, 50), rnd1, rnd2, rnd3).CreateShape();
        ...
        private static void CreateRandomRectangle(Canvas canvas)
        {
            ...
            Rectangle r = (Rectangle)new RectangleFactory("R" + rnd.Next(1, 50), rnd1, rnd2, rnd3, rnd4).CreateShape();
        ...
        private static void CreateRandomEllipse(Canvas canvas)
        {
            ...
            Ellipse e = (Ellipse)new EllipseFactory("E" + rnd.Next(1, 50), rnd1, rnd2, rnd3, rnd4).CreateShape();
            //Print to user what they created
        ...
        private static void CreateRandomLine(Canvas canvas)
        {
            ...
            Line l = (Line)new LineFactory("L" + rnd.Next(1, 50), rnd1, rnd2, rnd3, rnd4).CreateShape();
            //Print to user what they created
        ...
        private static void CreateRandomPolyLine(Canvas canvas)
        {
            ...
            PolyLine p = (PolyLine)new PolyLineFactory("P" + rnd.Next(1, 50), rnd1 + " " + rnd2 + " " + rnd3 + " " + rnd4 + " " + rnd5 + " " + rnd6 + " " + rnd7 + " " + rnd8 + " " + rnd9 + " " + rnd10 + " " + rnd11 + " " + rnd12 + " " + rnd13 + " " + rnd14 + " " + rnd15 + " " + rnd16 + " " + rnd17 + " " + rnd18 + " ").CreateShape();
            //Print to user what they created
        ...
        private static void CreateRandomPolygon(Canvas canvas)
        {
            ...
            Polygon pg = (Polygon)new PolygonFactory("PG" + rnd.Next(1, 50), rnd1 + " " + rnd2 + " " + rnd3 + " " + rnd4 + " " + rnd5 + " " + rnd6 + " " + rnd7 + " " + rnd8 + " " + rnd9 + " " + rnd10 + " " + rnd11 + " " + rnd12 + " " + rnd13 + " " + rnd14 + " " + rnd15 + " " + rnd16 + " " + rnd17 + " " + rnd18 + " " + rnd19 + " " + rnd20 + " ").CreateShape();
            //Print to user what they created
        ...
        private static void CreateRandomPath(Canvas canvas)
        {
            ...
            Path pt = (Path)new PathFactory("Path" + rnd.Next(1, 50), "M" + rnd1 + "," + rnd2 + " " + "Q" + rnd3 + "," + rnd4 + " " + rnd5 + "," + rnd6 + " " + "T" + rnd7 + "," + rnd8).CreateShape();
            //Print to user what they created
        ...
        private static void undo(Originator originator, Caretaker caretaker, Canvas canvas)
        {
            Console.WriteLine("\n" + "Undoing, in svg format!");
            canvas.undo(originator, caretaker);
        }
        private static void redo(Originator originator, Caretaker caretaker, Canvas canvas)
        {
    ...
    /// <summary>
    /// This canvas class is a singleton which means only one instance of it can be created per program running, no more than that
    /// The reason for choosing this pattern was to allow the user to draw only one canvas and not more than one so a consistency can be maintained
    /// and user can know which canvas they drew on.
    /// </summary>
    public class Canvas
    {
        ...
        public Canvas(Canvas other)
        {
            if (instanceCount == 1)
            {
                throw new Exception("Only one instance of Canvas can be created");
            }
            instanceCount++;
        ...
        public void undo(Originator originator, Caretaker caretaker)//undo method which implements the memento
        {
        ...
        public void redo(Originator originator, Caretaker caretaker)//redo method which implements the memento
        {
            Shape shape = caretaker.get(originator.createMemento()).getState();
            canvas.Add(shape);
        }
    }
